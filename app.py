...
def predict():
    ...
    for game in games_data:
        ...
        messages = []
        check_extremes_and_predictions(messages, current_total, min_total_score, max_total_score, mean_total_score, predicted_total, 'тотал')
        check_extremes_and_predictions(messages, current_home, min_home_score, max_home_score, mean_home_score, predicted_home, 'домашний счет')
        check_extremes_and_predictions(messages, current_away, min_away_score, max_away_score, mean_away_score, predicted_away, 'выездной счет')
...
def check_extremes_and_predictions(messages, current_value, min_value, max_value, mean_value, predicted_value, value_name):
